...
(function() {
  ...
  var letsDefinVarsWhouhouuu,

      ///////////////////////////////
      //////////// MAIN /////////////
      ///////////////////////////////

      runForestRun = function () {
        // BUSINESS MANAGER
        if (isBmPage()) {
      ...
      dqsa = (s) => {return document.querySelectorAll(s)},
      wfe = (e) => {return waitForElm(e)},
      wf = (e) => {return waitForElm(e)},

      isClassicBm = () => {return document.querySelector('#nav-flyout')===null},
      isModernBm = () => {return !isClassicBm()},
      ...
      bmModernRedesignMenu = () => {
        ...
        // NEW STYLE
        GM_addStyle('span.slds-context-bar__label-action.slds-context-bar__app-name.nav_expand_only.slds-truncate,.appswitcher-hide_from_search,main.ldsbm-homepage article.header,.slds-icon-utility-search,#bm-menu-search-collapsed,ul.slds-global-actions li:nth-child(2),ul.slds-global-actions li:nth-child(3),#leftside.collapsed section.slds-m-top_medium {display: none !important;}#globalfooter {font-size: 8px;}ccbm.ldsbm ccbm div.slds-context-bar__primary {height: 34px;padding-bottom: 0px;margin-top: 0px;margin-bottom: 0px;}.slds-template_app {padding: 0px;}img.header__logo-image {height: 10px !important;}div.slds-global-header__logo {position: absolute;right: 120px;}div.slds-global-header__item {padding-top: 4px;}ul.slds-global-actions:nth-child(2) {height: 10px;}div.slds-p-horizontal_medium.slds-p-top_medium.nav_expand_only {padding: 0px;}section.slds-popover:nth-child(3) {left: 8px !important;}.slds-dropdown_length-with-icon-7,.slds-dropdown--length-with-icon-7 {overflow-y: inherit;}ccbm .slds-p-horizontal_medium,ccbm .slds-p-horizontal--medium div {padding-left: 0rem;padding-right: 0rem;}ccbm .slds-p-top_medium,ccbm .slds-p-top--medium div {padding-top: 0rem;}div.slds-p-horizontal_medium:nth-child(1),div.slds-p-horizontal_medium:nth-child(2) {position: fixed;top: 0px;left: 0px;}div.slds-grid_align-spread {padding-left: 32px;}ccbm.cc-Staging {--cc-bm-instance-color-light: #cae3f9;}ccbm.cc-Production {--cc-bm-instance-color-light: #e0a599;}ccbm .slds-badge.cc-Sandbox {background-color: #807129;}ccbm.cc-Sandbox {--cc-bm-instance-color-light: #ece6c9;}#bens_topmenu_context_switcher {display: flex;position: fixed;top: 2px; text-transform: uppercase; font-weight: bold;}#bens_topmenu_context_switcher_merchant_tools,#bens_topmenu_context_switcher_administration {display: flex;position: relative;top: 2px;padding: 4px 8px 7px 8px;margin: 0px 5px 0px 0px;}#bens_topmenu_context_switcher_merchant_tools *,#bens_topmenu_context_switcher_administration * {text-decoration-style: none !important;}.slds-notification-badge.slds-incoming-notification.slds-show-notification {position: fixed;top: 2px;right: 81px}div.slds-text-align_center.slds-p-top_small.nav_collapsed_only.collapsed-width-limited.slds-text-align_center.slds-context-bar__app-short-name {display: block !important;}div.curtab {text-transform:uppercase;font-weight:bold;color:#fff;}.sbxenv {background-color:#807129;}.stgenv {background-color:#09429b;}.devenv {background-color:#194e31;}.prdenv {background-color:#8e030f;}.gradient_sbx {background-image: none,linear-gradient(0deg,rgba(1,68,134,0) 0,#807129);}.gradient_prd {background-image: none,linear-gradient(0deg,rgba(1,68,134,0) 0,#8e030f);}.gradient_stg {background-image: none,linear-gradient(0deg,rgba(1,68,134,0) 0,#014486);}.gradient_dev {background-image: none,linear-gradient(0deg,rgba(1,68,134,0) 0,#194e31);}.slds-m-around_medium,.slds-m-around--medium {margin: 5px;}ccbm.ldsbm #leftside.collapsed, .collapsed-width-limited {width: 3rem;}ccbm.ldsbm #nav-flyout {left: 3rem;}.ldsbm .dwClassic textarea, .ldsbm .dwClassic select, .ldsbm .dwClassic input[type="file"] {min-width: unset;}.infobox select{width: unset;}ccbm .ldsbm-homepage {gap: unset;}ccbm.ldsbm #nav-flyout[hidden] {left: -12.5rem;}.slds-p-around_x-small, .slds-p-around--x-small {padding: 0.2rem 0.1rem 0.0rem 0.1rem;}ccbm.ldsbm .slds-brand-band::before, div.customModule-wrapper .customModule-main::before {background-image: unset;}#leftnav-collapsed {-ms-overflow-style: none; scrollbar-width: none;}.boldifiedMenuLink{font-weight:bold;}#nav-flyout ul{display:flex; flex-direction:column}#leftside img {-webkit-filter: saturate(0) !important;filter: saturate(0) !important;}#globalfooter {height: 20px;}');

        // BENS ONLY STYLE
        if (isBde) GM_addStyle('#manage_associates_id01-flyout,#site-prefs_cdpdata-flyout,#site-prefs_abtest-flyout,#site-prefs_giftcertificates-flyout,#site-prefs_privacy-flyout,#site-prefs_hybridauth-flyout,#site-prefs_pinterest_commerce-flyout,#site-prefs_csc-flyout,#site-prefs_apple-pay-flyout,#site-prefs_intelligence_platform-flyout,#site-prefs_prodlocking-flyout,#site-prefs_storefronttoolkitprefs-flyout,#analytics-item{display: none !important;}');

        // Hide SBX scheduled jobs disabled messages
        let hideMessage = (e)=>{ let messageTohide = document.querySelector('div.dw-message h2')
          if (messageTohide?.innerHTML.indexOf('jobs disabled') > -1) messageTohide.parentElement.style.display = 'none';
        }
        wf('bm\\:jobs-list-screen-actions').then((e)=>hideMessage(e))
        wf('bm\\:job-editor-screen-schedule-and-history-tab').then((e)=>hideMessage(e))

        // ALPHABETICAL SORT OF SITE PREFS
        if (isBde) {
          wf('div.main-grid table tbody tr.dw-row').then((e)=>{
            const tbody = document.querySelector('div.main-grid table tbody');
            const rows = Array.from(document.querySelectorAll('div.main-grid table tbody tr.dw-row'));
            rows.sort((rowA, rowB) => {
              const a = rowA.cells[0]?.textContent?.trim().toLowerCase() || '';
              const b = rowB.cells[0]?.textContent?.trim().toLowerCase() || '';
              return a.localeCompare(b);
            }).forEach(row => tbody.append(row));
          })
        }

        // BOLDIFY and PUSH TO END Import & Export
        wf('#nav-flyout').then((o)=> {
          dqsa('#nav-flyout li a').forEach((e)=>{
            if (e.innerHTML.indexOf('Import') > -1) {
              e.classList.add('boldifiedMenuLink')
              e.parentElement.style.order = "1";
            } else  e.parentElement.style.order = "2";
          })
        })

        // ADD MERCH/ADMIN LINKS IN HEADER
        let merchA = 'Merchant Tools'
        ...
        leDivCtxSwitcher.innerHTML = '<div id="bens_topmenu_context_switcher_merchant_tools"><a class="slds-text-link_reset" href="/on/demandware.store/Sites-Site/default%3bapp%3d__bm_merchant%3bsite%3dQS-FR/ViewBM-Home">'+merchA+'</a></div><div id="bens_topmenu_context_switcher_administration"><a class="slds-text-link_reset" href="/on/demandware.store/Sites-Site/default%3bapp%3d__bm_admin%3bsite%3dQS-FR/ViewSetup-Home">Administration</a></div>';
        mainDiv.prepend(leDivCtxSwitcher)
        wf('#bmApplicationStateJSON').then((e)=>{
          let bmApplicationStateJSON = JSON.parse(e.innerHTML)
          document.querySelector('#bens_topmenu_context_switcher_merchant_tools a').innerHTML = bmApplicationStateJSON?.siteId
        })
        ...
        let siteSelector = dqs('#siteselect-collapsed input')
        let siteName = siteSelector ? dqs('#siteselect-collapsed input').value : 'nop' ;
      ...
      bmAddSearchOrdersSelectAllLink = function () {
        waitForElm('label[for=SiteOptionAllSites]').then((elm)=>{
          ...
          let clickAllButRuAndEu = ' <a href="#" class="clickAllButRuAndEu">Select all</a>';
          label.append(clickAllButRuAndEu)
          jQuery('.clickAllButRuAndEu').on('click',function(e){
            e.preventDefault();
      ...
      isBmPage = function () {
        return document.querySelector('ccbm.ldsbm') !== null;
      },
